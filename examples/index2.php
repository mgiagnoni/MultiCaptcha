...
<body>
<h1>Random font captcha</h1>
<p>Captcha code is displayed in a random font. This example uses only 2 fonts (see comments in <em>captcha2.php</em> source).</p>
<?php
...
<p>Enter the code displayed inside the image below</p>
<form action="index2.php" method="post">
<img id="captcha" src="captcha2.php" alt="captcha" /><br />
